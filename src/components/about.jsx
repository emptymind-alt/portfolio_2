        ...
        <section className="div-1 about">
          ...
          <div>
            <p className="text mt-4 mb-3">
              Hello! I'm Manas, a software development enthusiast, competitive
              coder, and researcher from India.
            </p>
            <p className="text my-3">
              I'm Master degree holder in {" "}
              <span style={{ color: "#63c9c6" }}>
              Computer Application
              </span>{" "}
              from <span style={{ color: "#63c9c6" }}>Ravenshaw University, Odisha</span>. I
              enjoy designing and creating beautiful web application / website
              . I seek and enjoy stuff that challenges me
